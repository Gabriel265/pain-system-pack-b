        ...
        {notifications.map((notification) => (
          ...
          >
            <div className="flex gap-3 sm:gap-4">
              {/* Icon/Avatar */}
              <div
                className={`w-10 h-10 sm:w-12 sm:h-12 ${getIconColor(notification.type)} rounded-full flex-shrink-0 flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow`}
              >
