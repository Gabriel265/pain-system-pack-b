                  ...
                  {selectedIds.size > 0 && (
                    <div className="flex flex-wrap gap-3">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium flex items-center gap-2"
                      >
                        Delete
                      </button>
                    </div>
                        ...
                        <thead className="bg-white  sticky top-0 z-20 shadow-sm">
                          <tr>
                            ...
                            >
                              ...
                              <span
                                onMouseDown={(e) =>
                                  startResize("category", e.clientX)
                                }
                                className="absolute right-0 top-0 h-full w-1 cursor-col-resize bg-black/20"
                              />
                            </th>
